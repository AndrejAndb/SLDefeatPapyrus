Scriptname dcur_lb_RingGagScript extends zadequipscript  
...
Function OnEquippedPre(actor akActor, bool silent=false)
	...
	if akActor == libs.PlayerRef						
		msg = "You put the ring gag on your head and pull the straps tight before you lock them in place with padlocks."		
	Else
		msg = "You put the ring gag over "+GetMessageName(akActor)+"'s head and close the zippers before you lock them in place with padlocks."
	EndIf
	if !silent
