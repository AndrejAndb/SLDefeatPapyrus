...
Scriptname dcur_dollmaker_buydevices Extends TopicInfo Hidden
...
Function doit(Actor dm)
	...
	If ItemsTaken < 5
		...
		While i > 0
			...
			i -= 1
		EndWhile
		libs.notify("You did not have enough used restraints the Dollmaker was interested in.", messagebox = true)
		return
	Endif
	libs.notify("The Dollmaker found " + ItemsTaken + " restraints she wants to buy from you.", messagebox = true)
