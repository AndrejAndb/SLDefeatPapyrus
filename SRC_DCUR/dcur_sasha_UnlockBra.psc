...
Scriptname dcur_sasha_UnlockBra Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
	Armor device = libs.GetWornDevice(akSpeaker, libs.zad_DeviousBra)
	if !device		
		libs.notify(akSpeaker.GetLeveledActorBase().GetName() + " is not wearing a chastity bra!")
		Return
	Endif
