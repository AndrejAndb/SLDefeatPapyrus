Scriptname dcur_lb_BeltScript extends zadequipscript  
...
Function DeviceMenu(Int msgChoice = 0)
	...
	elseif msgChoice == 1	; Remove device, with key
		if !lbqs.lb_hasremoved_Harness
			libs.Notify("You cannot remove the chastity belt as long as the harness is still locked on you!", messageBox=true)		
			return
		endif
		if UnlockDialogue()			
