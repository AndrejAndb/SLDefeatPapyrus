Scriptname dcur_onreadhint1 extends ObjectReference  
...
event onread()	
	...
	if libs.PlayerRef.GetItemCount(ccqs.dcur_cursedbelt) < 1
		return
	endif
	; Only change the quest stage if the player isn't wearing the item already!
	if !libs.IsWearingDevice(libs.PlayerRef, ccqs.dcur_cursedbeltRendered, libs.zad_DeviousBelt) && ccqs.GetStage() != 50
		ccqs.closecurrentStage(ccqs.collarquest_getactualstage())	
		ccqs.SetStage(50)	
		ccqs.SetObjectiveDisplayed(50)
	endif	
endevent