...
Scriptname dcur_royalchastity_setStage100 Extends TopicInfo Hidden
...
;BEGIN CODE
	...
	GetOwningQuest().SetObjectiveCompleted(91)
	GetOwningQuest().SetObjectiveDisplayed(100)
	rcqs.alias_royalchastity_LoverStone.GetReference().Enable()
