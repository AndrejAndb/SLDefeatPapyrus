...
Function WaitSandbox(Actor slave_actor)
	PAH.GetSlave(slave_actor).WaitSandbox()
EndFunction
...
Function FixNakedOutfit(Actor slave_actor)
	PAH.GetSlave(slave_actor).FixNakedOutfit()
EndFunction
...
Function RemoveSlave(Actor slave_actor)
	PAH.GetSlave(slave_actor).Release()
EndFunction

Function AddSlave(Actor slave_actor)
	PAH.AddSlave(slave_actor)
EndFunction
