...
Bool Function CanBreakRestraint(Form cuffs)
	...
	If ((cuffs == PAH.PAHEzbfCuffsSteel) || cuffs.haskeyword(pah.PahRestraintMaterialSteel))
		restraintModifier = (baseValue * 2)
	ElseIf (cuffs == (PAH.CuffsIron || PAH.CuffsIronBrown || PAH.zbfAnkleSteel))
		restraintModifier = (baseValue * 1.5)
	ElseIf (cuffs == (PAH.CuffsSimpleBlack || PAH.CuffsSimpleBrown))
		restraintModifier = (baseValue * 1.4)
	ElseIf (cuffs == (PAH.CuffsLeather || PAH.AnkleIron || PAH.zbfAnkleIronBrown))
...
Float Function ChanceRespectful()
	...
	elseif (slave.respect_training >= 100)
		...
		if ((mood == "angry") && (slave.respect_training < 100))
