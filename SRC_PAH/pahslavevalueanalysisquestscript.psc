...
Function Calculate(Actor _slave)
	...
	If (Game.GetModByName("paradise_halls_SLExtension.esp") != 255)
		If (PAHTrainSex == None)
			PAHTrainSex = Game.GetFormFromFile(0x004067, "paradise_halls_SLExtension.esp") As Faction
  		EndIf
 	EndIf
    ...
    If (PAHTrainPose == None)
        PAHTrainPose = Game.GetFormFromFile(0x00059BD5, "paradise_halls.esm") As Faction 
    EndIf
	If (PAHTrainFear == None)
		PAHTrainFear = Game.GetFormFromFile(0x0001BB4E, "paradise_halls.esm") As Faction
	EndIf
