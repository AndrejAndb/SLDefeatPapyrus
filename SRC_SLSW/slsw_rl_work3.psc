scriptname slsw_rl_work3 extends quest  
...
referencealias property whore3 auto
...
event whore3client(string eventname, string argstring, float argnum, form sender)
endevent
